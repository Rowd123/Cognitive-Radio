...
#ifndef ADHOC_ALOHA_NOACK_COGNITIVE_PHY_HELPER_H
#define ADHOC_ALOHA_NOACK_COGNITIVE_PHY_HELPER_H
...
class AdhocAlohaNoackCognitivePhyHelper
{
  public:
    AdhocAlohaNoackCognitivePhyHelper();
    ~AdhocAlohaNoackCognitivePhyHelper();
    ...
    * Set these Attibutes to each AlohaNoackCongitiveNetDevice
    */
    void SetThreshold(double threshold);

    /**
    * @param local set the local spectrum for the channel
    */
  ...
  protected:
    ...
    Ptr<SpectrumValue> m_local;     //!< the local spectrum of the channel
    double m_threshold;              //!< the threshold of sensing the specturm 
};
...
AdhocAlohaNoackCognitivePhyHelper::SetAntenna(std::string type, Ts&&... args)
{
...
#endif /* ADHOC_ALOHA_NOACK_COGNITIVE_PHY_HELPER_H */