...
#ifndef COGNITIVE_RADIO_ENERGY_MODEL_HELPER_H
#define COGNITIVE_RADIO_ENERGY_MODEL_HELPER_H
...
class CognitiveRadioEnergyModelHelper : public DeviceEnergyModelHelper
{
  public:
    /**
     * Construct a helper which is used to add a radio energy model to a node
     */
    CognitiveRadioEnergyModelHelper();

    /**
     * Destroy a RadioEnergy Helper
     */
    ~CognitiveRadioEnergyModelHelper() override;
