#ifndef ALOHA_NOACK_COGNITIVE_NET_DEVICE_H
#define ALOHA_NOACK_COGNITIVE_NET_DEVICE_H
...
class AlohaNoackCognitiveNetDevice : public NetDevice
{
  public:
    /**
    ...
    AlohaNoackCognitiveNetDevice();
    ~AlohaNoackCognitiveNetDevice() override;

    /**
    * @brief returns the total number of packets received
    * @return the number of packets
    */
    static uint32_t GetTotalReceivedPackets();
  ...
  private:
    ...
    inline static uint32_t TotalNumberOfPackets = 0 ;  
};
